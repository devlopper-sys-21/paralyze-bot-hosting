...
async function getHelpMenu({ client, guild }) {
  ...
  const embed = new MessageEmbed()
    ...
    .setThumbnail("https://media.discordapp.net/attachments/915416382932385802/934963936225267712/logo_paaralyze.png?width=670&height=670")
    .setDescription(
      "**About Me:**\n" +
        `Hello I am ${guild.me.displayName} Bot!\n\n` +
        "⬇ Go down and choose a category of commands you want to see with the dropdown menu.\n\n"
    );
