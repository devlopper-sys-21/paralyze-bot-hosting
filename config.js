module.exports = {
  OWNER_IDS: ["468883993383665676"], // Bot owner ID's
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "861563466401316874", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
